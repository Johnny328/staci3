...
colorBarFontSize = 12;
colorElement = "Node"; % "Node" or "Pipe" or "All" or "Both" (Pipe and Node)
...
% start of plotting
for i=1:pipeCounter
    if(colorElement == "Pipe" || colorElement == "All" || colorElement == "Both")
...
for i=1:nodeCounter
    if(colorElement == "Node" || colorElement == "All" || colorElement == "Both")
